...
TFT_eSPI *tft = NULL;
TFT_eSprite *graph1 = NULL; // Sprite object graph1
TFT_eSprite *stext1 = NULL; // Sprite object stext1
TFT_eSprite *stext2 = NULL; // Sprite object stext2
...
void setup()
{
    ...
    graph1   = new TFT_eSprite(tft); // Sprite object
    stext1   = new TFT_eSprite(tft); // Sprite object
    stext2   = new TFT_eSprite(tft); // Sprite object
