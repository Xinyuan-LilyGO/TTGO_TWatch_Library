...
void setup()
{
    ...
    spr   = new TFT_eSprite(tft); // Sprite object
...
void loop(void)
{
    ...
    spr->pushSprite(tft->width() / 2 - SWIDTH / 2, tft->height() / 2 - SHEIGHT / 2, 10);
    ...
    // Draw some lines
    spr->drawLine(1, 0, SWIDTH, SHEIGHT - 1, 10);
    spr->drawLine(0, 0, SWIDTH, SHEIGHT, 10);
    spr->drawLine(0, 1, SWIDTH - 1, SHEIGHT, 10);
    spr->drawLine(0, SHEIGHT - 1, SWIDTH - 1, 0, 12);
    spr->drawLine(0, SHEIGHT, SWIDTH, 0, 12);
    spr->drawLine(1, SHEIGHT, SWIDTH, 1, 12);
...
// Draw some text with Middle Centre datum
    ...
    spr->drawRect(0, 0, SWIDTH, SHEIGHT, 15); // Blue rectangle
