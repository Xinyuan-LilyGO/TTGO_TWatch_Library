...
TFT_eSprite *dial   = NULL; // Sprite object for dial
...
void setup()
{
    ...
    dial   = new TFT_eSprite(tft); // Sprite object for eSpLoaction
    needle   = new TFT_eSprite(tft); // Sprite object for eSpLoaction
